...
flowchart TD
    ...
    A --> B["ពាក្យស្នើសុំរៀបចំ/កែប្រែឯកសារ (នាយកដ្ឋាន/បុគ្គលិកពាក់ព័ន្ធ)<br>文件编制/修订申请 (相关部门/人员)<br>Document preparation/revision application (relevant department/personnel)"]
